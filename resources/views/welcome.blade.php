    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="py-6 px-4">
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                <h1 class="text-brand-elite text-3xl font-bold">Elite Plus</h1>
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-12">
            <div class="max-w-4xl mx-auto text-center">
                <h2 class="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                    ...
                    <span class="text-brand-elite block mt-2">One Tap Away</span>
                </h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    @guest
                        <a href="{{ route('login') }}"
                            class="bg-brand-elite text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-opacity-90 transition shadow-lg">
                            Get Started
                        </a>
                    @else
                        <a href="{{ route('dashboard') }}"
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center p-6">
                        <div
                            class="bg-brand-elite w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <footer class="py-6 border-t border-brand-gray">
            <div class="max-w-7xl mx-auto px-4 text-center">
                <p class="text-brand-light text-sm">
                    &copy; {{ date('Y') }} Elite Plus. All rights reserved.
                </p>
            </div>
        </footer>
    </div>
