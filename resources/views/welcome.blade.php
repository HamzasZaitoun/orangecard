...
<head>
    ...
    <title>OrangeCard - NFC Digital Business Cards</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="py-6 px-4">
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                <h1 class="text-brand-orange text-3xl font-bold">OrangeCard</h1>
            ...
            <div class="max-w-7xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center p-6">
                        <div class="bg-brand-orange w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <footer class="py-6 border-t border-brand-gray">
            <div class="max-w-7xl mx-auto px-4 text-center">
                <p class="text-brand-light text-sm">
                    &copy; {{ date('Y') }} OrangeCard. All rights reserved.
                </p>
            </div>
        </footer>
    </div>
