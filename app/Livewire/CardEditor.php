<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 bg-gradient-to-r from-brand-orange via-red-500 to-yellow-500 rounded-2xl p-8 text-white shadow-2xl relative overflow-hidden">
        <div class="relative z-10">
            <h2 class="text-3xl font-bold mb-2">Welcome to OrangeCard! 🎉</h2>
            <p class="text-white/90 text-lg">Let's create your digital business card. Fill in your information below.</p>
        </div>
                ...
                <form wire:submit="save" class="space-y-6">
                    ...
                    <div class="text-center pb-6 border-b border-brand-light">
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            ...
                            @else
                            <div class="w-32 h-32 rounded-full bg-gradient-to-br from-brand-orange to-red-500 flex items-center justify-center text-white text-4xl font-bold shadow-lg">
                                {{ substr($first_name ?: 'U', 0, 1) }}
                            </div>
                            @endif

                            <label class="cursor-pointer">
                                <div class="bg-brand-orange text-white px-6 py-3 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-200 flex items-center space-x-2">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div wire:loading wire:target="profile_image" class="text-brand-orange text-sm flex items-center space-x-2">
                    ...
                    <div class="space-y-6">
                        <div class="group">
                            <label class="block text-sm font-semibold text-brand-black mb-2 group-focus-within:text-brand-orange transition flex items-center">
                ...
                <div class="bg-gradient-to-br from-brand-black to-gray-900 rounded-2xl p-6 shadow-2xl">
                    ...
                    <div class="bg-white rounded-xl p-6 text-center">
                        ...
                        <div class="flex justify-center mb-4">
                            <div class="w-24 h-24 rounded-full bg-brand-orange border-4 border-brand-orange overflow-hidden">
                                @if($current_image)
                        ...
                        @else
                        <div class="flex justify-center mb-4">
                            <div class="w-24 h-24 rounded-full bg-gradient-to-br from-brand-orange to-red-500 flex items-center justify-center text-white text-3xl font-bold">
                                {{ substr($first_name ?: 'U', 0, 1) }}
                            </div>
                        </div>
                        @endif
